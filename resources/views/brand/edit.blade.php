        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('brand.update', encrypt($brand->id))}}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ $brand->nama }}">
                                @error('nama')
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror">{{$brand->alamat}}</textarea>
                                @error('alamat')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ $brand->phone }}">
                                @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
